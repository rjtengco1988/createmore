...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url('assets/images/favicon.png'); ?>" sizes="32x32">
...
<body class="bg-body-secondary d-flex justify-content-center align-items-center vh-100">
    <div class="card shadow rounded-4 p-4" style="max-width: 400px; width: 100%;">
        <div class="text-center mb-3">
            <!-- LOGO IMAGE -->
            <img src="<?= base_url('assets/images/logo.png'); ?>" alt="DTI Logo" class="img-fluid mx-auto d-block mb-2" style="max-height: 80px;">

            <!-- HEADER TITLE -->
            <h3 class="fw-bold">
                <a href="<?= base_url(); ?>" class="text-decoration-none text-dark">
                    <span class="text-primary">DTI</span> Create More
                </a>
            </h3>
        </div>
        ...
        <div class="text-center mb-3 text-muted">
            You can try signing in again below.
        </div>
